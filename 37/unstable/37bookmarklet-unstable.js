...
if ((window.location.hostname.endsWith("testportal.net") || window.location.hostname.endsWith("testportal.pl"))) {
  ...
  window.location.href.indexOf('InfInvalidLinkFormat.html') > -1) {
    ...
    if ((window.location.href.includes("DoStartTest.html") || window.location.href.includes("DoTestQuestion.html") || window.location.href.includes("LoadQuestion.html") || window.location.href.includes("StartNextAttempt.html")) && (window.location.hostname.endsWith("testportal.net") || window.location.hostname.endsWith("testportal.pl"))) 
    {
